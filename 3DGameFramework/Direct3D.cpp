...
Microsoft::WRL::ComPtr<ID3D11Device>			g_pd3dDevice;							// DirectX11のデバイス
Microsoft::WRL::ComPtr<ID3D11DeviceContext>		g_pImmediateContext;					// コンテキスト
Microsoft::WRL::ComPtr<IDXGISwapChain>			g_pSwapChain;							// スワップチェイン
Microsoft::WRL::ComPtr<ID3D11RenderTargetView>	g_pRenderTargetView;					// レンダーターゲットビュー
Microsoft::WRL::ComPtr<ID3D11Texture2D>			g_pDepthStencil;						// 深度ステンシル
Microsoft::WRL::ComPtr<ID3D11DepthStencilView>	g_pDepthStencilView;					// 深度ステンシルビュー
...
#ifdef _DEBUG
// createDeviceFlags |= 03D11_CREATE_DEVICE_DEBUG; // デバックレイヤーをサポートするフラグ
#endif
